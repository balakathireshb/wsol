...
jQuery(document).ready(function () {
  ...
  var getTablesData = jQuery('#getTablesData1_btn');
  ...
  jQuery(function() {
    ...
    getTablesData.removeAttr("disabled");
  ...
  getTablesData.click(function(){
    InsertGraphvizText(jQuery("#tablesData_text").html().trim());
  });
